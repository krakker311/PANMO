@if($message->from_user == \Auth::user()->id)
    ...
    <div class="row msg_container base_sent" data-message-id="{{ $message->id }}" id="message-line-{{$message->id}}">
            ...
            <div class="messages msg_sent text-right">
                ...
                @elseif($message->image)
                    <div style="width: 100%;"> 
                        ...
                        <img src="{{ $message->fromUser->image }}" alt="Generic placeholder image" class="img-fluid img-thumbnail mt-4 " style="width: 150px; z-index: 1;">
                        @else
        ...
        <div class="col-md-3 col-xs-3 avatar">
            <img src="{{ $message->fromUser->image }}" width="50" height="50" class="img-responsive">
        </div>
    </div>
        ...
        <div class="col-md-9 col-xs-9">
            <div class="messages msg_receive text-left">
                ...
                @elseif($message->image)
                    <div style="width: 100%;">
                        @if($message->fromUser->image)
                        <img src="{{ $message->toUser->image }}" alt="Generic placeholder image" class="img-fluid img-thumbnail mt-4 " style="width: 150px; z-index: 1;">
                        @else
                        <img src="{{ asset('storage/profile/default.jpg') }}" alt="Generic placeholder image" class="img-fluid img-thumbnail mt-4 " style="width: 150px; z-index: 1;">
                        @endif
                    </div>
